...
//注入头部开始
function installParticles(pixi) {
    //注入头部结束
    ...
    ***************************************************************************** */
    ...
    Particles.AnimatedParticle = AnimatedParticle;
    Particles.Emitter = Emitter;
    Particles.GetTextureFromString = GetTextureFromString;
    Particles.LinkedListContainer = LinkedListContainer;
    Particles.Particle = Particle;
    Particles.PathParticle = PathParticle;
    Particles.PolygonalChain = PolygonalChain;
    Particles.PropertyList = PropertyList;
    Particles.PropertyNode = PropertyNode;
...
module.exports = installParticles
//注入尾部结束
